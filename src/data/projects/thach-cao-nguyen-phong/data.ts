...
export const pricingData = {
  ...
  description:
    "Chúng tôi cung cấp các gói dịch vụ thi công thạch cao đa dạng, phù hợp với mọi nhu cầu và ngân sách của bạn.",
  ...
  steps: [
    {
      ...
      description: "Lắng nghe và ghi nhận mọi yêu cầu từ khách hàng.",
    },
    {
      icon: IconMessageDots,
      title: "Tư vấn & Báo giá",
      description: "Đưa ra giải pháp tối ưu và báo giá cạnh tranh.",
    },
    {
      icon: IconGauge,
      title: "Ký kết hợp đồng",
      description: "Thống nhất các điều khoản và tiến hành ký kết.",
    },
    {
      icon: IconGauge,
      title: "Thi công & Giám sát",
      description:
        "Thực hiện công việc với đội ngũ chuyên nghiệp, giám sát chặt chẽ.",
    },
    {
      icon: IconGauge,
      title: "Nghiệm thu & Bàn giao",
      description: "Kiểm tra chất lượng và bàn giao công trình đúng hạn.",
    },
  ],
};
  ...
  items: [
    {
      ...
      description: "Vật liệu cao cấp, đội ngũ tay nghề cao.",
    },
    {
      icon: IconMessageDots,
      title: "Giá cả cạnh tranh",
      description: "Tối ưu chi phí, mang lại giá trị tốt nhất.",
    },
    {
      icon: IconGauge,
      title: "Tiến độ nhanh chóng",
      description: "Hoàn thành đúng hẹn, không chậm trễ.",
    },
  ],
};
  ...
  items: [
    {
      icon: IconGauge,
      title: "Sơn nước",
      description: "Dịch vụ sơn nước chuyên nghiệp, bền đẹp.",
    },
    {
      icon: IconMessageDots,
      title: "Sửa chữa nhà",
      description: "Sửa chữa, cải tạo nhà ở theo yêu cầu.",
    },
    {
      icon: IconGauge,
      title: "Thiết kế nội thất",
      description: "Tư vấn, thiết kế không gian sống hiện đại.",
    },
  ],
};
...
export const contact = {
  ...
  finalCtaDescription:
    "Đừng ngần ngại liên hệ với chúng tôi để nhận được sự tư vấn tận tình và báo giá chi tiết cho dự án của bạn.",
