    ...
    (id: string, field: keyof CustomField, newValue: string) => {
      setCustomFields((fields) =>
        fields.map((f) => {
          if (f.id !== id) return f;
          if (field === "key") {
            const predefined = PREDEFINED_KEYS.find(
              (k) => k.value === newValue,
            );
            return {
              ...f,
          ...
          <Stack gap="sm">
            ...
            <Group grow>
              ...
              <Switch
                ...
                onChange={(e) =>
                  setWifiData({ ...wifiData, hidden: e.currentTarget.checked })
                }
              />
            </Group>
          </Stack>
              ...
              <Group key={field.id} gap="xs" align="flex-end">
                ...
                {field.key === "X-CUSTOM" && (
                  <TextInput
                    ...
                    placeholder="KEY"
                    onChange={(e) =>
                      updateCustomField(field.id, "key", e.currentTarget.value)
                    }
                  />
                )}
                <TextInput
                  ...
                  value={field.value}
                  onChange={(e) =>
                    updateCustomField(field.id, "value", e.currentTarget.value)
                  }
                />
                <ActionIcon
                  color="red"
