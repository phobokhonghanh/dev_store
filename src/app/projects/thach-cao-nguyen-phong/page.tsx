...
import {carouselImages, pricingData, processSteps, benefits, otherServices, contact } from '@/data/projects/thach-cao-nguyen-phong/data';
 ...
 */
function InfoCard({ item }: { item: { icon: React.FC<{ size: number; }>; title: string; description: string } }) {
