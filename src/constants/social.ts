...
export const SOCIAL = [
  ...
  { name: 'YouTube', url: 'https://youtube.com/your-channel', icon: IconBrandYoutube },
  { name: 'Instagram', url: 'https://instagram.com/your-profile', icon: IconBrandInstagram },
  { name: 'GitHub', url: 'https://github.com/your-profile', icon: IconBrandGithub },
];
