const config = require('@origini/tailwind-config/tailwind.config.mjs')
...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      // - @origini/tailwind-config/claude.theme.js (claude-*, claude-gray-*)
      // - @origini/tailwind-config/colors.js (ivory, oat, cream, cactus, sage, lavender, terracotta, coral)
