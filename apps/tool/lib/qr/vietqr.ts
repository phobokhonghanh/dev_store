...
export const BANKS: Bank[] = [
  ...
  { bin: '970409', shortName: 'BAB', name: 'Bac A Bank' },
  ...
  { bin: '970444', shortName: 'CBB', name: 'CB Bank' },
  { bin: '970415', shortName: 'CTG', name: 'VietinBank' },
  { bin: '970406', shortName: 'DOB', name: 'DongA Bank' },
  { bin: '970431', shortName: 'EIB', name: 'Eximbank' },
  { bin: '970408', shortName: 'GPB', name: 'GPBank' },
  ...
  { bin: '970449', shortName: 'LPBANK', name: 'LPBank' },
  ...
  { bin: '970414', shortName: 'OceanBank', name: 'OceanBank' },
  { bin: '970430', shortName: 'PGB', name: 'PGBank' },
  { bin: '970439', shortName: 'PBVN', name: 'Public Bank' },
  ...
  { bin: '970424', shortName: 'SHBVN', name: 'Shinhan Bank' },
  ...
  { bin: '970458', shortName: 'UOB', name: 'UOB' },
  ...
  { bin: '970421', shortName: 'VRB', name: 'VRB' },
  { bin: '970457', shortName: 'WVN', name: 'Woori Bank' },
