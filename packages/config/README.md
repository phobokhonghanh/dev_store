...
```typescript
import { appConfig, blogConfig, insightsConfig } from "@origini/config";
...
```typescript
import { apiConfig, githubConfig, wakatimeConfig } from "@origini/config";
...
import { getWakaTimeRange, calculateBackoffDelay } from "@origini/config";
...
```typescript
// apps/insights/app/github/page.tsx
import { githubConfig } from "@origini/config";
