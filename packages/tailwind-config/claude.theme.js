...
export const safelist = [
  ...
  {
    pattern: /^bg-claude-(peach|mint|lavender|coral|yellow|sky|beige|cream|tan|brown|copper|orange|black)$/,
    variants: ['hover', 'dark'],
  },
  // Claude gray scale
  {
  ...
  // Claude color text
  {
    pattern: /^text-claude-(peach|mint|lavender|coral|yellow|sky|beige|cream|tan|brown|copper|orange|black)$/,
    variants: ['hover', 'dark'],
  },
  ...
  {
    pattern: /^border-claude-(peach|mint|lavender|coral|yellow|sky|beige|cream|tan|brown|copper|orange|black)$/,
    variants: ['hover', 'dark'],
  },
