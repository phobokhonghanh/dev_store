 ...
 * @example
 * ```ts
 * import { createProfile, originiProfile } from '@origini/profile'
 *
 * // Use default profile
 * const profile = originiProfile
 *
 * // Or customize it
 ...
 * @example
 * ```ts
 * const myProfile = createProfile(originiProfile, {
 *   personal: {
 *     name: "Jane Doe",
 *     email: "jane@example.com"
 *   }
...
// Re-export origini's profile as the default example
export { originiProfile } from "./origini.profile";
export { originiProfile as defaultProfile } from "./origini.profile";
