/**
 * Utility functions for @origini/urls package
 *
 ...
 * @example
 * ```ts
 * import { originiUrls, createUrls } from '@origini/urls'
 *
 * const myUrls = createUrls(originiUrls, {
 *   apps: {
 ...
 *
 * const nav = createNavigation(originiUrls, originiProfile)
 *
 * // Use in components
 ...
 * @example
 * ```ts
 * const appUrls = getAppUrls(originiUrls)
 * // { blog: "...", cv: "...", insights: "...", ... }
 * ```
 */
 ...
 * @example
 * ```ts
 * const blogUrl = getAppUrl(originiUrls, "blog")
 * // "https://blog.pho.net"
 * ```
 */
